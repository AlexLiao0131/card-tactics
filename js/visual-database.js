...
window.VisualDatabase=(()=>{function get(group,id){return VISUALS[group]?.[id]||null;}function asset(group,id,key){return get(group,id)?.[key]??null;}function presentation(group,id){return VISUALS.presentation?.[group]?.[id]||null;}return{get,asset,presentation};})();
